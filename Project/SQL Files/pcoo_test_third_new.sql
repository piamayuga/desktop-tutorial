...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2022 at 07:44 PM
...
--
-- Table structure for table `pds_1`
--
...
--
-- Table structure for table `pds_2`
--
...
--
-- Table structure for table `pds_3`
--
...
--
-- Table structure for table `pds_4`
--
...
--
-- Table structure for table `pds_5`
--
...
--
-- Table structure for table `pds_6`
--
...
--
-- Table structure for table `pds_7`
--
...
--
-- Indexes for table `pds_1`
--
ALTER TABLE `pds_1`
  ADD PRIMARY KEY (`employeeID`);

--
-- Indexes for table `pds_2`
--
ALTER TABLE `pds_2`
  ADD PRIMARY KEY (`employeeID`);

--
-- Indexes for table `pds_3`
--
ALTER TABLE `pds_3`
  ADD PRIMARY KEY (`employeeID`);

--
-- Indexes for table `pds_4`
--
ALTER TABLE `pds_4`
  ADD PRIMARY KEY (`employeeID`);

--
-- Indexes for table `pds_5`
--
ALTER TABLE `pds_5`
  ADD PRIMARY KEY (`employeeID`);
